#ifndef PARAMETERS_6_H
#define PARAMETERS_6_H

// Save file locations
#define DIR_NAME "parameters_set6"
//time fixation 
//comparaison avec RA 
//pour arte_difference=9e-2 comparaison avec ra
// Model parameters
...
#define TARGET_POP 100// target population. Nss in literature.
#define REPLICATIVE_ADVANTAGE 8e-3 // replicate advantage coefficient in the RA model. kra in literature.
#define DENSITY 1  // inverse density in the SSD model. delta in literature
#define RATE_DIFFERENCE 6e-2 // rate difference in the SSS model. epsilon in literature. 
