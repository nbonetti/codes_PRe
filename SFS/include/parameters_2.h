...
// Save file locations
#define DIR_NAME "parameters_set2"
//paramètres pour des chain of units 
//test pour le modele sss  
...
#define TARGET_POP 5// target population. Nss in literature.
#define REPLICATIVE_ADVANTAGE 0.05 // replicate advantage coefficient in the RA model. kra in literature.
#define DENSITY 0.2 // inverse density in the SSD model. delta in literature
#define RATE_DIFFERENCE 2e-2 // rate difference in the SSS model. epsilon in literature. 
#define LEN_GENOME 16569 // length of mtDNA genome

// Simulation parameters
#define SIM_LENGTH 20000.0 // total simulation length in time
#define INTRODUCE_AFTER 10000.0 // introduce a single deletion mutant at this time
